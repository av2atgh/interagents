...
Encoding group interactions on hypergraphs is by now a standard device for
evolutionary games, where it changes the replicator dynamics and supplies a
mechanism for the survival of cooperation~\cite{alvarez2021,perc2013}; what
follows applies it to a coordination requirement inside a queue. We
